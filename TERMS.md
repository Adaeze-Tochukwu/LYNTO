...
By accessing or using Lynto ("the Service"), you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions. If you do not agree to these terms, you must not access or use the Service.

## 2. Description of Service

Lynto is a healthcare observation and alert management platform designed to assist care agencies in monitoring client wellbeing. The Service enables:
- Carers to record visit observations including symptoms, vital signs, and notes
- Managers to review health-related alerts and coordinate care responses
- Agencies to maintain records of client visits and health status changes

## 3. Eligibility

The Service is intended for use by registered care agencies and their authorised personnel. By using the Service, you represent that:
- You are at least 18 years of age
- You are authorised to act on behalf of the registered agency
- You have the necessary qualifications and permissions to provide care services
- You will comply with all applicable healthcare regulations in your jurisdiction
...
- You must not share account credentials with unauthorised individuals
...
**LYNTO DOES NOT PROVIDE MEDICAL ADVICE OF ANY KIND.** The Service is a documentation and alerting tool only. The Service:
- Does NOT diagnose medical conditions
- Does NOT recommend treatments
- Does NOT replace professional medical judgment
- Does NOT substitute for emergency medical services

### 5.2 Risk Assessment Limitations
The symptom scoring and risk classification features (green, amber, red) are decision-support tools designed to flag potential concerns. They:
- Are NOT validated diagnostic instruments
...
### 6.1 Proper Use
Users agree to:
- Use the Service only for its intended purpose of healthcare observation recording
- Provide accurate and truthful information in all visit entries
- Record observations promptly and completely
- Follow their agency's policies and procedures for care documentation

### 6.2 Prohibited Conduct
Users must NOT:
- Use the Service for any unlawful purpose
- Provide false, misleading, or inaccurate information
- Access records of clients they are not authorised to view
- Share client information with unauthorised parties
...
### 7.1 Personal and Health Data
- All personal and health data is processed in accordance with applicable data protection legislation including UK GDPR and the Data Protection Act 2018
- Users must ensure they have appropriate consent and legal basis for recording client information
- Data should only be accessed on a need-to-know basis

### 7.2 Data Controller Responsibilities
The registered agency acts as the Data Controller for client information entered into the Service. Agencies are responsible for:
- Ensuring lawful basis for processing client data
- Providing appropriate privacy notices to clients
- Responding to data subject access requests
- Reporting data breaches to relevant authorities

### 7.3 Data Security
Users must:
- Access the Service only on secure, password-protected devices
- Not store or transmit client data outside the Service without authorisation
- Report any suspected data breaches immediately to their agency administrator
- Follow their agency's information security policies

### 7.4 Data Retention
Client and visit data is retained in accordance with healthcare record-keeping requirements. Please refer to our Privacy Policy for detailed information on data retention periods.

## 8. Confidentiality

Users acknowledge that information accessed through the Service includes sensitive personal and health information. Users agree to:
- Maintain strict confidentiality of all client information
- Comply with professional codes of conduct regarding confidentiality
...
- Request from your employing agency
...
**By using Lynto, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.**

---

Sources referenced in creating these terms:
- [Medisafe Terms and Conditions](https://www.medisafe.com/terms-and-conditions/)
- [Termly Mobile App Terms Template](https://termly.io/resources/templates/app-terms-and-conditions/)
- [TermsFeed Terms and Conditions Generator](https://www.termsfeed.com/blog/sample-mobile-app-terms-conditions-template/)
